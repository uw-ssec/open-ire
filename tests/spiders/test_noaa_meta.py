...
from open_ire.spiders.noaa_meta import NOAAMetaSpider
...
class TestNOAAMetaSpider:
    ...
    def test_normalize_field_value(self):
        ...
        assert NOAAMetaSpider._normalize_field_value([]) is None
    ...
    def test_extract_keywords(self):
        ...
        # Single keyword
        keywords = NOAAMetaSpider._extract_keywords("sample")
